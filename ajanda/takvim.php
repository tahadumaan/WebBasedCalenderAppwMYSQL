...
//$strTarih = "2020-10-22";
//$strTarih = date("Y-m-d");
$strIlkGun = date("Y-m-01", strtotime($strTarih));
$strSonGun = date("Y-m-t", strtotime($strTarih));
...
$strAyIsim = date("F", strtotime($strTarih));
?>
...
<table border="1" cellspacing="0" cellpadding="5" width="90%" height="60%" style="background-color: #EAEAEA">
    ...
    <?php while ($strTakvimGun <= $strTakvimSon) { ?>
        ...
        <?php if (date("m", strtotime($strTakvimGun)) == date("m", strtotime($strTarih))) { ?>
            <td style="width:55px; text-align:center"
                <?php if($strTarih == $strTakvimGun){ ?> bgcolor="red" <?php } ?>
                <?php if(((date("N", strtotime($strTakvimGun))) == 6) or ((date("N", strtotime($strTakvimGun))) == 7) ){ ?> bgcolor="a7e0e0"
                <?php } ?>
